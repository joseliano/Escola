...
CREATE SEQUENCE IF NOT EXISTS public.aluno_id_aluno_seq
    INCREMENT 1
    START 1
    MINVALUE 1
    MAXVALUE 2147483647
...
ALTER SEQUENCE public.aluno_id_aluno_seq
    OWNER TO postgres;
	 
CREATE SEQUENCE IF NOT EXISTS  public.disciplina_id_disciplina_seq
    INCREMENT 1
    START 1
    MINVALUE 1
    MAXVALUE 2147483647
...
ALTER SEQUENCE public.disciplina_id_disciplina_seq
    OWNER TO postgres;


CREATE SEQUENCE IF NOT EXISTS  public.nota_aluno_id_nota_seq
    INCREMENT 1
    START 1
    MINVALUE 1
    MAXVALUE 2147483647
...
ALTER SEQUENCE public.nota_aluno_id_nota_seq
    OWNER TO postgres;
...
(
    id_disciplina integer NOT NULL DEFAULT nextval('disciplina_id_disciplina_seq'::regclass),
    nome character varying(80) COLLATE pg_catalog."default",
...
(
    id_nota integer NOT NULL DEFAULT nextval('nota_aluno_id_nota_seq'::regclass),
    ano character varying(4) COLLATE pg_catalog."default",
    bimestre character varying(1) COLLATE pg_catalog."default",
    id_aluno integer,
    id_discplina integer,
    CONSTRAINT nota_aluno_pkey PRIMARY KEY (id_nota),
    CONSTRAINT fk8e2lprn5r8q8sukior7n7fhe5 FOREIGN KEY (id_discplina)
        REFERENCES public.disciplina (id_disciplina) MATCH SIMPLE
        ON UPDATE NO ACTION
        ON DELETE NO ACTION
        NOT VALID,
    CONSTRAINT fkhtaw9ep89t9ijo41vacg8bm8t FOREIGN KEY (id_aluno)
...
insert into bimestre (id_bimestre,nome_bimestre)
select 01,' P1' union all
select 02,' P2' union all
select 03,' P3'  ;	
